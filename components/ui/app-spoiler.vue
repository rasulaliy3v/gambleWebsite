<template>
  <div class="spoiler">
    ...
    <div ref="body" class="spoiler__body" :style="{ height: bodyHeight }">
      <p class="pb-4">
        <slot name="text"
          >EZCASH - financial games with the withdrawal of real funds. For now
           The site presents the 5 most popular money games. EZCASH
           registered in the UK and operating in
           in accordance with all established legal regulations.
        </slot>
      </p>
    </div>
  </div>
